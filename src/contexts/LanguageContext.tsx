...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "services.subtitle":
      "Below are the services we provide at Etege Taitu Sub-city Shewareged Gedele Kebele.",
    "services.newId": "Issue New ID",
    "services.newId.desc":
      "If a resident comes from another kebele, they must bring a reference from their previous kebele and a guarantor who is a resident of our kebele.",
    ...
    "services.documents.desc":
      "The applicant must bring an application, photo, and renewed ID",
    ...
    "services.land.desc":
      "The applicant must bring marriage contract, photos, renewed IDs of husband and wife, and renewed IDs of witnesses",

    "services.support": "Issue Debt-Free Certificate",
    "services.support.desc":
      "The applicant must bring an application and renewed ID",

    "services.registery": "Provide Housing Association Information",
    "services.registery.desc":
      "The applicant must bring a letter from thier office",
    ...
    "about.mission.text":
      "To provide customers with efficient and quality service, to provide customers with transparent service, to ensure customer satisfaction.",

    "about.vision": "The Kebele's Mission",
    "about.vision.text":
      "To effectively, efficiently, and accessibly execute government and organizational tasks and customer services within the kebele.",

    "about.charter": "The Kebele's Vision",
    "about.charter.text":
      "To see the kebele residents benefiting from good administration and overcoming poverty and backwardness",
    ...
    "newsletter.description":
      "Subscribe to our daily newsletter for new services and public announcements.",
    ...
    "contact.info.subtitle":
      "Fill out the form below and we will get back to you as soon as possiblet",
    "contact.phone": "Phone",
    "contact.email": "Email",
  ...
  am: {
    ...
    "services.subtitle":
      "በ እቴጌ ጣይቱ ክፍለ ከተማ ሸዋረገድ ገድሌ ቀበሌ የምንሰጣቸው አገልግሎቶች ከታች ይመልክቱ።",
    "services.newId": "አዲስ መታወቂያ መስጠት",
    "services.newId.desc":
      "ባለጉዳይ ከሌላ ቀበሌ የመጣ ከሆነ ከመጣበት ቀበሌ መሸኛ እና በቀበሌያችን ነዋሪ የሆነ ሰው ተያዥ ማቅረብ ይኖርባቸዋል።",
    ...
    "services.documents.desc":
      "ባለጉዳይ ማመልከቻ ፣ ጉርድ ፎቶ እና የታደሰ መታወቂያ ይዞ መቅረብ አለበት",
    ...
    "services.land.desc":
      "ባለጉዳይ የጋብቻ ውል ፣ ጉርድ ፎቶ የባልና የሚስት የታደሰ መታወቂያ እና የምስክሮች የታደሰመታወቂያ መቅረብ አለበት",
    ...
    "about.mission.text":
      "ተገልጋዩች ቀልጣፋ እና ጥራት ያለው አገልግሎት ለመስጠት ተገልጋዮች ግልፀኝነት ያለው አገልግሎት ለመስጠት ተገልጋዮችን ተጠቃሚነት እርካታ ለማረጋገጥ።",

    "about.vision": "የቀበሌው ተልዕኮ",
    "about.vision.text":
      "በቀበሌው ውስጥ የሚሰሩ የመንግስት እና የድርጅት ስራዎችን እና የደንበኞችን አገልግሎት በብቃት፤በጥራት መምራት በተደራሽነት መፈፀም መቻል።",

    "about.charter": "የቀበሌው ራዕይ",
    "about.charter.text":
      "ቀበሌው ህዝብ ከመልካም አስተዳደር ችግር ወጥቶ ማየት ጠቃሚነት ሲያረጋግጥ ማየት ቀበሌው ህዝብ ከድህነት እና ኃላቀርነት ተላቆ ማየት",
    ...
    "newsletter.description":
      "ለአዳዲስ አገልግሎቶች እና የህዝብ ማስታወቂያዎች የእለት ዜና መጽሔታችንን ይመዝገቡ።",
    ...
    "contact.hours.time": "2:30 ጠዋት - 11:30 ምሽት፣ ሰኞ - አርብ",
